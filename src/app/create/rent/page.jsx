...
const rent = () => {
    ...
    const handleRent = async (e) => {
        ...
        axios.post('/api/rent/register', data)
            .then(() => {
    ...
    return (
        <div className='container mx-auto p-5 md:p-10'>
            ...
            <div>
                <h2 className='text-xl md:text-2xl lg:text-3xl font-medium lg:font-semibold text-center mt-2'>Add Post for Rent</h2>
            </div>
            <div className='mt-4'>
                {
                    loading ?
                        ...
                        <form className="space-y-4" onSubmit={handleRent}>
                            <div className='grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3'>
                                ...
                                <div>
                                    <label htmlFor="land_type" className="block text-sm font-medium leading-6 text-gray-900">
                                        Land Type
                                    </label>
                                    <div className="mt-2">
                                        <input
                                ...
                                <div>
                                    <label htmlFor="advance_pay" className="block text-sm font-medium leading-6 text-gray-900">
                                        Advance Pay ($)
                                    </label>
                                    <div className="mt-2">
                                        <input
                                ...
                                <div>
                                    <label htmlFor="monthly_rent" className="block text-sm font-medium leading-6 text-gray-900">
                                        Monthly Rent ($)
                                    </label>
                                    <div className="mt-2">
                                        <input
                                ...
                                <div>
                                    <label htmlFor="bathroom" className="block text-sm font-medium leading-6 text-gray-900">
                                        How many bathrooms?
                                    </label>
                                    <div className="mt-2">
                                        <input
