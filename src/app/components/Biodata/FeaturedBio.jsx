...
const FeaturedBio = () => {
    ...
    const temp = biodata.reverse().slice(0, 4);

    return (
        <div>
            <div className='container mx-auto'>
                <div className='flex justify-between items-center'>
                    <h2 className='text-2xl font-semibold mt-4 mb-3 text-center'>Marriage S.D</h2>
                    <Link href='/category/marriage-s-d' shallow> see more</Link>
                </div>
                {
                    !open &&
                    <>
