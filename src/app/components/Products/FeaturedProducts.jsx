...
const FeaturedProducts = () => {
    ...
    const temp = products.reverse().slice(0, 4);

    return (
        <div>
            <div className='container mx-auto'>
                <div className='flex justify-between items-center'>
                    <h2 className='text-2xl font-semibold mt-4 mb-3 text-center'>Business Product</h2>
                    <Link href='/category/business-product' shallow>see more</Link>
                </div>
                {
                    !open &&
                    <>
