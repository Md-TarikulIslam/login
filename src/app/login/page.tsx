        ...
        <div className="bg-white">
            <div className="flex flex-col  justify-center min-h-screen w-96 mx-auto py-2">
                ...
                <input
                    ...
                    required
                />
                <button onClick={onLogin} className="btn bg-blue-700 text-white rounded-lg py-2 text-xl my-6">Login</button>
                <p className="text-center mt-8">New User? <Link className="text-blue-700" href="/signup">Register</Link></p>
            </div>
        </div>
    )
